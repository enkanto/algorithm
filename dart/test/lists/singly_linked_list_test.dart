...
void main() {
  ...
  test(
    ...
    () {
      var node1 = Node(10);
      expect([node1.data, node1.next], equals([10, null]));

      var node2 = Node(0, next: node1);
      expect([node2.data, node2.next], equals([0, node1]));
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(theStooges.toList, equals(["Moe", "Larry", "Shemp", "Curly"]));
