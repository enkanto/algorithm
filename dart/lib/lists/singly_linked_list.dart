...
class Node<T> {
  ...
  /// We initiate a [Node] either just the data or with the [next]
  ///
  /// ```dart
...
class SinglyLinkedList<T> {
  ...
  /// show the element at position [position]. `null` for invalid positions.
  T at(int position) {
  ...
  /// Inserts [data] at [position]. Rasies exception for invalid positions.
